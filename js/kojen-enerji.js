...
const KojenEnerji = {
    ...
    checkExistingRecords: function() {
        ...
        // GoogleSheetsAPI kontrolü

        if (!window.GoogleSheetsAPI) {

            console.error('❌ GoogleSheetsAPI yüklenmedi!');

            if (window.Utils && Utils.showToast) {

                Utils.showToast('❌ GoogleSheetsAPI yüklenmedi!', 'error');
    ...
    saveData: function() {
        ...
        GoogleSheetsAPI.saveData('kojen_enerji', checkData)
            ...
            .then(checkResult => {
                ...
                console.log('🔍 Backend yanıtı:', checkResult);
                ...
                console.log('🔍 Kayıt kontrolü sonucu:', hasExistingRecord);
    ...
    sendToGoogleSheets: function(data, motor, date) {
        ...
        if (window.GoogleSheetsAPI) {
            ...
            // Saat formatını HH:00:00 olarak ayarla
const currentHour = new Date().getHours().toString().padStart(2, '0') + ':00:00';
            ...
            const sheetData = {
                ...
                guncelleyen: window.Auth?.getCurrentUser()?.name || window.Auth?.getCurrentUser()?.username || 'Bilinmeyen Kullanıcı',
    ...
    : new Date().toLocaleDateString('tr-TR', {
        ...
        month: '2-digit',
        year: 'numeric'
    }).replace(/\./g, '/');  // Noktaları / ile değiştir
            ...
            if (window.GoogleSheetsAPI) {
                ...
                console.log('🔍 İkinci kontrol - Backend yanıtı:', checkResult);
                console.log('🔍 İkinci kontrol - Kayıt kontrolü sonucu:', hasExistingRecord);
                ...
                const saveData = {
                    ...
                    allData: JSON.stringify({[currentHour]: devreDisiData}),
